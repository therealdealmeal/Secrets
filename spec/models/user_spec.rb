...
RSpec.describe User, type: :model do
  ...
  it "accepts properly formatted email" do
    emails = ['chrisj@ruby.com', 'chris.j@ruby.com']
  ...
  it "requires a unique, case insensitive email address" do
    ...
    user2 = User.new(name:"ray", email:"kobe@lakers.com", password:"password", password_confirmation:"password")
    user2.valid?
  ...
  it "requires the password to match the password confirmation" do
    user = User.new(name:"kobe", email:"kobe@lakers.com", password:"password", password_confirmation:"word")
    user.valid?
